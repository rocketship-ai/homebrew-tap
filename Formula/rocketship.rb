class Rocketship < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/rocketship-ai/rocketship/releases/download/v0.5.42/rocketship-darwin-arm64"
      sha256 "eb4f12dcd7adc5e10a4aa6f5298939340f2710d3421f4836470c6db9aeed6d9c"
    end
    on_intel do
      url "https://github.com/rocketship-ai/rocketship/releases/download/v0.5.42/rocketship-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/rocketship-ai/rocketship/releases/download/v0.5.42/rocketship-linux-arm64"
      sha256 "b242ec841089d9b869de4d3efce77992012f803e60f8296555455985c05e52fb"
    end
    on_intel do
      url "https://github.com/rocketship-ai/rocketship/releases/download/v0.5.42/rocketship-linux-amd64"
